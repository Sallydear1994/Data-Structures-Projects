...
// User test cases
TEST(SkipListSet_SanityCheckTests, UsercanCreateAndDestroy)
{
    SkipListSet<int> s1;
    SkipListSet<std::string> s2;   
}
...
TEST(SkipListSet_SanityCheckTests, UserAddFirstElement)
{
    SkipListSet<int> s1;
    s1.add(11);
    EXPECT_TRUE(s1.contains(11));
...
TEST(SkipListSet_SanityCheckTests, UserAddTwoElementsWithOneLess)
{
    SkipListSet<int> s1;
    s1.add(15);
    s1.add(11);
...
TEST(SkipListSet_SanityCheckTests, UserAddTwoElementsWithOneGreater)
{
    SkipListSet<int> s1;
    s1.add(11);
    s1.add(22);
...
TEST(SkipListSet_SanityCheckTests, UserAddTwoElementsWithDuplicate)
{
    SkipListSet<int> s1;
    s1.add(11);
    s1.add(11);
...
TEST(SkipListSet_SanityCheckTests, UserAddThreeElements)
{
    SkipListSet<int> s1;
    s1.add(23);
    s1.add(14);
...
TEST(SkipListSet_SanityCheckTests, UserAddMoreElements)
{
    SkipListSet<int> s1;
    s1.add(11);
    s1.add(12);
...
TEST(SkipListSet_SanityCheckTests, UserAddEvenMoreElements)
{
    SkipListSet<int> s1;
    s1.add(14);
    s1.add(5);
...
TEST(SkipListSet_SanityCheckTests, UserTestCopyConstructor)
{
    SkipListSet<int> s1;
    s1.add(14);
    s1.add(5);
...
TEST(SkipListSet_SanityCheckTests, UserTestCopyAssignment)
{
    SkipListSet<int> s1;
    s1.add(14);
    s1.add(5);
...
TEST(SkipListSet_SanityCheckTests, UserTestMoveConstructor)
{
    SkipListSet<int> s1;
    s1.add(14);
    s1.add(5);
    ...
    s1.add(24);
    s1.add(7);
    SkipListSet<int> s2{std::move(s1)};
}
